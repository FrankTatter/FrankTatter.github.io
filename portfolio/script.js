...
function onClick(event) {
    ...
    if(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && obj == "chair3"){
        ...
        console.log(obj);
        newUrl = "https://franktatter.github.io/portfolio/"+obj+".html"
